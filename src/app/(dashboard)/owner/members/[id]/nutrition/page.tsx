...
import { TrainerMemberNutritionClient, type SerializedRecentLog, type DayTypeTarget } from '@/app/(dashboard)/trainer/members/[id]/nutrition/_components/trainer-member-nutrition-client';
