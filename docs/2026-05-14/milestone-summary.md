...
| 指标 | Phase 1（2026-04-23）| 当前（2026-05-14）|
|------|----------------------|-------------------|
| Jest 测试数 | 234 | **1,227** |
| Jest 测试套件 | 50 | **199** |
| E2E spec 文件 | 0 | **42** |
...
2. **B — 训练进阶追踪** — 上次重量提示，推荐增重徽章，每动作重量趋势
3. **A — 数据导出** — 体测 / 训练历史导出 CSV
4. **H — 会员训练反馈** — 完成后 RPE + 疲劳度 + 文字备注
5. **E — 营养日志** — 会员自录每日实际摄入 vs 计划对比
