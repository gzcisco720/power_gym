...
export function NutritionTemplateList({ templates, onDelete, basePath = '/owner/nutrition-templates' }: Props) {
                ...
                >
                  ...
                  {onDelete && (
                    <Button
                      variant="ghost"
                      size="icon"
                      onClick={() => void onDelete(template._id)}
