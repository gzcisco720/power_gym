    ...
    todayLog != null ? (
      <div className="mt-auto flex flex-col gap-2">
        ...
        <Button
          variant="outline"
          type="button"
          onClick={() => navigate(freestyleDayPath(props.basePath))}
        >
  ...
  return (
    <div className="rounded-xl bg-card ring-1 ring-foreground/10 p-4 flex flex-col">
      ...
      <div className="rounded-lg ring-1 ring-foreground/10 p-3 mb-3 bg-foreground/[0.02]">
        ...
        <div className="text-lg font-bold">{lastFreestyle.kcal.toLocaleString()} kcal</div>
      ...
      {props.state === 'full' && (
        <p className="text-[11px] text-foreground/65 mb-3">{props.daysThisWeek}× this week</p>
      )}
      {todayCTA ?? (
        <Button
          variant="outline"
